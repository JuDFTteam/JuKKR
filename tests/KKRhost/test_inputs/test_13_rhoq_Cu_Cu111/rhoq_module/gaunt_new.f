C ************************************************************************
      SUBROUTINE GAUNT_NEW(LMAX,LMAX2,LPOT,W,YR,CLEB,LOFLM,ICLEB,IEND,
     &                 JEND,NCLEB,LMAXD,LMPOTD)
C ************************************************************************
c
...
C     ..
C     .. Array Arguments ..
      DOUBLE PRECISION CLEB(NCLEB),W(*),
     &                 YR(4*LMAXD,0:4*LMAXD,0:4*LMAXD) 
      !4*LMAXD,0:LPOT,0:(2*LPOT+1)**2)
      INTEGER ICLEB(NCLEB,3),JEND(LMPOTD,0:LMAX,0:LMAX2),
     &        LOFLM((2*LPOT+1)**2)  !  *)
C     ..
C     .. Local Scalars ..
...
!      &  I,ICLEB(i,1),ICLEB(i,2),ICLEB(i,3),CLEB(I),
