...
if [[ ! -d test_case_kkrflex_host_in_host/imp/test_run_mpi_1 ]]; then
  echo "test 1"
  cd test_case_kkrflex_host_in_host/imp/
...
if [[ ! -d test_case_kkrflex_host_in_host/imp/test_run_mpi_8 ]]; then
  echo "test 2"
  cd test_case_kkrflex_host_in_host/imp/
...
if [[ ! -d test_case_kkrflex_host_in_host/imp/test_run_hybrid_1_1 ]]; then
  echo "test 3"
  cd test_case_kkrflex_host_in_host/imp/
...
if [[ ! -d test_case_kkrflex_host_in_host/imp/test_run_hybrid_1_8 ]]; then
  echo "test 4"
  cd test_case_kkrflex_host_in_host/imp/
...
if [[ ! -d test_case_kkrflex_host_in_host/imp/test_run_hybrid_8_1 ]]; then
  echo "test 5"
  cd test_case_kkrflex_host_in_host/imp/
...
if [[ ! -d test_case_kkrflex_host_in_host/imp/test_run_hybrid_2_4 ]]; then
  echo "test 6"
  cd test_case_kkrflex_host_in_host/imp/
...
if [[ ! -d test_case_kkrflex_host_in_host/imp/test_run_hybrid_4_2 ]]; then
  echo "test 7"
  cd test_case_kkrflex_host_in_host/imp/
...
if [[ ! -d test_case_kkrflex_host_in_host/imp/test_run_tmatnew_hybrid_2_4 ]]; then
  echo "test 8"
  cd test_case_kkrflex_host_in_host/imp/
...
if [[ ! -d test_case_kkrflex_host_in_host/imp/test_run_tmatnew_mpi_8 ]]; then
  echo "test 9"
  cd test_case_kkrflex_host_in_host/imp/
...
if [[ ! -f test_case_kkrflex_host_in_host/imp/test_run_nosavewf/out ]]; then
  echo "test 10"
  cd test_case_kkrflex_host_in_host/imp/test_run_nosavewf/
  ln -s ../../../../kkrflex.exe_hybrid kkrflex.exe
  export OMP_NUM_THREADS=1; mpirun -np 8 ./kkrflex.exe | tee out
  cd ../../../
fi
  
if [[ ! -f test_case_kkrflex_host_in_host/imp/test_run_nosratrick/out ]]; then
  echo "test 11"
  cd test_case_kkrflex_host_in_host/imp/test_run_nosratrick/
  ln -s ../../../../kkrflex.exe_hybrid kkrflex.exe
  export OMP_NUM_THREADS=1; mpirun -np 8 ./kkrflex.exe | tee out
  cd ../../../
fi
