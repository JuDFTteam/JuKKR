...
LDFLAGS= -L/usr/local/intel/Compiler/11.1/059/mkl/lib/em64t -lmkl_intel_lp64 -lmkl_intel_thread -lmkl_core -liomp5 -lpthread -L./libs/FEAST/3.0/lib/x64 -lfeast_dense -lfeast #including FEAST library
#========================================================
