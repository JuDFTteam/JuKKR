...
contains
  ...
  ! containing the main parameters from the TB-KKR calculation.
    ...
    use mod_ioformat, only: fmt_fn_ext, ext_formatted, filename_tbkkrparams, filename_tbkkrrhod
    ...
    implicit none
      ...
      integer            :: mask_inc, ierr
      character(len=80)  :: filename, uio
  ...
  ! containing the main variables from the TB-KKR calculation.
    ...
    implicit none
      ...
      integer            :: i1, i2, ie, lm1, lm2, isigma, ierr
