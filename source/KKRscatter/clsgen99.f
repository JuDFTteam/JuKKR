...
c         OPEN(8,FILE='clusters',STATUS='UNKNOWN')
c         WRITE(8,9005) NAEZ
c         WRITE(8,9030) ALAT
c         WRITE(8,9010) (Z(KAOEZ(1,I)),I=1,NAEZ)
c         WRITE(8,9020) (KAOEZ(1,I),I=1,NAEZ)
      END IF
Cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ICLUSTER = 1
      DO N = 1,NCLSD
...
Cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
          IF (TEST('clusters')) THEN
c             WRITE(8,FMT=1030) NUMBER
c             WRITE(8,FMT=1030) JATOM,IC
             DO I=1,NUMBER
                R = SQRT(
     &               RCLS(1,I,IC)**2+RCLS(2,I,IC)**2+RCLS(3,I,IC)**2)
c                WRITE(8,1041) (RCLS(II,I,IC),II=1,3),ATOM(I,JATOM),
c     &               Z(ABS(ATOM(I,JATOM))),R      
             END DO
          END IF
Cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
