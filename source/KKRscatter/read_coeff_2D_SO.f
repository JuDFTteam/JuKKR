      SUBROUTINE READ_COEFF_2D_SO(COEFF_0,BZKP,LMMAXSO,NKPOID,NAEZ,ENTG,
     +                            NSPOH)
...
c     +              action="read",iostat=status_open)
      ...
      ELSE
c        open(unit=318, file="coefficients_0_rot" , form="formatted",
c     +              action="read",iostat=status_open)
        open(unit=318, file="coefficients_0_rot" , form="unformatted")
      END IF
...
c     +                 COEFF_0(LM1,I1,ENT,NK)
     ...
     +                 COEFF_0(LM1,I1,ENT,NK)
      ...
      END SUBROUTINE READ_COEFF_2D_SO
