      SUBROUTINE SPINORBIT_HAM_TEST(LMAX,LMMAXD,VINS,RNEW,E,Z,C,NSRA,
     +                  NSPIN,LMPOTD,IPAN_INTERVALL,RPAN_INTERVALL,
     +                  NPAN_TOT,NCHEB,IRMDNEW,VNSPLL,THETA,PHI,MODE,
     +                  IAT)

      IMPLICIT NONE 

      INTEGER LMAX,LMMAXD,NSPIN,NSRA,NPAN_TOT,NCHEB,IRMDNEW,LMPOTD,IAT
...
c add to potential
      ...
      END SUBROUTINE SPINORBIT_HAM_TEST
