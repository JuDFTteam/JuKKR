...
! writE(321,'(5000F)') Umat
! writE(322,'(5000F)') Udeggamat
!***********************************************************************
...
! do ir=1,nrmaxd
!   do ilm=1,lmpotd
!     rho2ns(ir,ilm,3)= dimag (&
!     +(rho2nsc(ir,ilm,1)*W1_11W2_12)  &
!     -(rho2nsc(ir,ilm,3)*W1_11W2_22) &
!     -(rho2nsc(ir,ilm,4)*W1_12W2_12) &
!     +(rho2nsc(ir,ilm,2)*W1_12W2_22))
! 
!     rho2ns(ir,ilm,4)= dimag (&
!     +(rho2nsc(ir,ilm,1)*W1_21W2_11)  &
!     -(rho2nsc(ir,ilm,3)*W1_21W2_21) &
!     -(rho2nsc(ir,ilm,4)*W1_22W2_11) &
!     +(rho2nsc(ir,ilm,2)*W1_22W2_21))
!   end do
! enddo 
