...
#define APPLY_PRECOND(X) call APPBLCKCIRC(X,GLLHBLCK,NLEN/num_columns,num_columns,natbld,xdim,ydim,zdim)
...
#define NINE 7
  ...
  subroutine MMINVMOD_bcp(smat, sparse, mat_X, mat_B, TOL, num_columns, NLEN, initial_zero, &
    ...
    ! for preconditioning
    integer, intent(in) :: bcp, natbld, xdim, ydim, zdim
    ...
    do IT=1, NLIM
      ...
      ! v1 = v1 + eta*v7
      COLUMN_AXPY(ETA, VECS(:,:,SEVEN), mat_X)  ! final result
