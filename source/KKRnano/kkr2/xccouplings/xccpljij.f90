...
!>  Communicates integrated Jij between energy processes (if necessary)
!>  sum them up and write output.
!>  @param LMPIC  =1: write output, =0 don't write output
subroutine XCCPLJIJ_OUT( &
I1, &
RXIJ,NXIJ,IXCP,RXCCLS, &
LMPIC, &
