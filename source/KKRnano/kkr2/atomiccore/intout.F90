...
!     .. locals ..
      ...
      double precision, parameter :: r1=1.d0/9.d0, r2=-5.d0*r1, r3=19.d0*r1, r83sq=64.d0/9.d0, h83 = 8.d0/3.d0 ! positive!!
      integer :: i,i1,k,km1,n
      double precision :: d(2,3),px(20),qx(20)

      zz = z + z
      cvlight = 274.0720442d0; if (nsra == 1) cvlight = 1.0d0
      ea = exp(a)
      fllp1 = l*(l + 1.d0)
      aa = -zz/cvlight
      bb = fllp1 - aa*aa
