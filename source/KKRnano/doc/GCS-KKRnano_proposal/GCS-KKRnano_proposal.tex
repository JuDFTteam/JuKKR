...
OpenMP threads which can be used in production runs. By changing the computational algorithms
...
with KKRnano. 
\\
B20-MnGe is currently subject to extensive investigation in the solid state physics community
...
The by far most important task connected to large-scale DFT calculations for MnGe is the search for
...
A lot of interesting research has already been done on the interplay of
...
We are going to extend this research to B20-MnGe and
