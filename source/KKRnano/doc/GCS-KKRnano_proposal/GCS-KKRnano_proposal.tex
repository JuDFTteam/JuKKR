...
\\
As a first step towards unraveling the mystery of skyrmionic textures in MnGe B20 we
...
topologically protected skyrmionic textures \cite{bornemann_investigation_2017}.
...
KKRnano was granted a substantial amount of computing time by several committees in the past years.
From 2014 to 2016 alone we succesfully applied for 18.5 million core-h on JUQUEEN
and 0.45 million core-h on JURECA.
...
the head node
before launching the parallel large-scale calculation .
