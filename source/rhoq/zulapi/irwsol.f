C ************************************************************************
      SUBROUTINE IRWSOL(EK,LMAX,FZ,HAMF,MASS,PZ,QZ,SZ,DROR,S,IPAN,IRCUT)
C ************************************************************************
...
c    and adams - moulton predictor corrector method integrating from
c    irt inwards and extented for potentials with kinks
c
c
...
c
c---> use wronski relation near origine
c
        DO 40 IR = IRWSK,2,-1
c
