C*==calctref.f    processed by SPAG 6.05Rc at 15:24 on 18 Oct 2004
...
C
      ...
      CIOVE = CI/SQRT(ERYD)
C
      CALL BESHAN(HANKWS1,BESSJW1,BESSYW1,A1,0,LMAXDP1)
      CALL BESHAN(HANKWS2,BESSJW2,BESSYW2,B1,0,LMAXDP1)
C
      DO L1 = 0,LMAX
