  ...
  subroutine read_inputcard(ifile)
    ...
    if (.not.inputcard_is_read) then
      ...
      do iline = 1, nlines
        ...
        if (ierror==1) then
          write(1337,'(A26,I0,A14)') 'Warning capitalizing line ', iline, ' of inputcard.'
          write(*   ,'(A26,I0,A14)') 'Warning capitalizing line ', iline, ' of inputcard.'
        else if (ierror==2) then
          write(1337,'(A26,I0,A14)') 'Error capitalizing line ', iline, ' of inputcard.'
          write(*,   '(A26,I0,A14)') 'Error capitalizing line ', iline, ' of inputcard.'
          stop
        end if
      end do
