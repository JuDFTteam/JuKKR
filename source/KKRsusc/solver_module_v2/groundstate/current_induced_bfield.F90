...
! -----------
  ...
  real(kind=r8b)                      :: tmprgaunt,r(1:nr)
...
! ilm components for x,y,z
  ilmxyz(1)=lm2i(1,1);ilmxyz(2)=lm2i(-1,1);ilmxyz(3)=lm2i(0,1)

! curr = int curr * r^2
! curr_r = int curr * r^3 with gaunt coeff (see notes / dipole)
! curr_r_r = int curr * r^4 with gaunt coeff (see notes / quadrupole)
  ...
  write(777,'(100f16.8)') (real(curr(a)),a=1,3), ((real(curr_r(a,b)),a=1,3),b=1,3), (((real(curr_r_r(a,b,c)),a=1,3),b=1,3),c=1,3)! IO file for current induced magnetic fields
