  subroutine dynamic_susc(onsite,struct)
...
! -----------------------------------------------------------------
  ...
  complex(kind=c8b) :: norm, de, e, norm2, eim, de1, de2
  ...
  integer(kind=i4b) :: iw, jw, iew, iew0, iew1, jew, jew0, jew1
...
!  call cpu_time(start)
!  call analytic_continuation(nw,nweb,nwef,onsite,struct)
!  call cpu_time(finish)
!  write(*,'(/," Dynamic KS susc acont time=",f10.3," s")') finish-start
  uparam = 1.d0/uparam
  write(*,*) "uparam=", uparam
  close(iofile)
...
!           E - w - i0
            ...
            do j=1,jq1-jq0
              ...
              do i=1,iq1-iq0
                ...
                norm = (conjg(de)*gfjiw(q2,q3)*gfij0(q4,q1) - de*gfijw(q2,q3)*gfji0(q4,q1))/i2pi
            ...
            gfij0up = conjg(gfji0up); gfij0dn = conjg(gfji0dn)
            gfjiwup = conjg(gfijwup); gfjiwdn = conjg(gfijwdn)
...
!            gfjiwup = gfjiw(lmsb2i(1,5,2,ia),lmsb2i(1,5,2,ia)); gfjiwdn = gfjiw(lmsb2i(1,5,1,ia),lmsb2i(1,5,1,ia))
            chi0escf_updn = chi0escf_updn + (conjg(de)*gfjiwup*gfij0dn - de*gfijwup*gfji0dn)/i2pi
            chi0escf_dnup = chi0escf_dnup + (conjg(de)*gfjiwdn*gfij0up - de*gfijwdn*gfji0up)/i2pi
          end do            ! energy
...
!             E - w - i0
              ...
              do j=1,jq1-jq0
                ...
                do i=1,iq1-iq0
                  ...
                  i3 = i2almsbgf(:,iq)
                  q1 = i3(1); q2 = i3(2)!; ia = i3(3)
                  norm = de*(gfijw(q2,q3) - gfjiw(q2,q3))*gfij0(q4,q1)/i2pi
                  suscblock(i,j) = suscblock(i,j) + norm
                end do
              end do
...
!              gfijwup = gfijw(lmsb2i(1,5,2,ia),lmsb2i(1,5,2,ia)); gfijwdn = gfijw(lmsb2i(1,5,1,ia),lmsb2i(1,5,1,ia))
!              gfjiwup = gfjiw(lmsb2i(1,5,2,ia),lmsb2i(1,5,2,ia)); gfjiwdn = gfjiw(lmsb2i(1,5,1,ia),lmsb2i(1,5,1,ia))
              chi0eb_updn = chi0eb_updn + de*(gfijwup - gfjiwup)*gfij0dn/i2pi
              chi0eb_dnup = chi0eb_dnup + de*(gfijwdn - gfjiwdn)*gfij0up/i2pi
            end do  ! energy
!         ++++++
          end do
!         ++++++
...
!              gfijwup = gfijw(lmsb2i(1,5,2,ia),lmsb2i(1,5,2,ia)); gfijwdn = gfijw(lmsb2i(1,5,1,ia),lmsb2i(1,5,1,ia))
!              gfjiwup = gfjiw(lmsb2i(1,5,2,ia),lmsb2i(1,5,2,ia)); gfjiwdn = gfjiw(lmsb2i(1,5,1,ia),lmsb2i(1,5,1,ia))
              chi0ef_updn = chi0ef_updn - de*(gfijwup - gfjiwup)*gfij0dn/i2pi
              chi0ef_dnup = chi0ef_dnup - de*(gfijwdn - gfjiwdn)*gfij0up/i2pi
            end do  ! energy
!         ++++++
          end do
!         ++++++
...
!         get the projected GFs
!         E + i0
          call projected_gf(ie,ia,ja,gfij0,onsite,struct) 
          if (lrot) call local_frame(ia,ja,magdir,gfij0,gf)
!         E - w + i0
          call projected_gf(ie,ja,ia,gfjiw,onsite,struct)
          if (lrot) call local_frame(ja,ia,magdir,gfjiw,gf)
!         E - w - i0
!          call projected_gf(ie,ia,ja,gfijw,onsite,struct)
!          if (lrot) call local_frame(ia,ja,magdir,gfijw,gf)
          gfijw = conjg(transpose(gfjiw))
!         E - i0
!          call projected_gf(ie,ja,ia,gfji0,onsite,struct)
!          if (lrot) call local_frame(ja,ia,magdir,gfji0,gf)
          gfji0 = conjg(transpose(gfij0))
          do j=1,jq1-jq0
            jq = jq0 + j
            i3 = i2almsbgf(:,jq)
            q3 = i3(1); q4 = i3(2)!; ja = i3(3)
            do i=1,iq1-iq0
              ...
              i3 = i2almsbgf(:,iq)
              q1 = i3(1); q2 = i3(2)!; ia = i3(3)
              norm = (conjg(de)*gfji0(q2,q3)*gfijw(q4,q1) - de*gfij0(q2,q3)*gfjiw(q4,q1))/i2pi
              suscblock(i,j) = suscblock(i,j) + norm
            end do
          end do
          gfij0up = 1.d0/(esusc(ie) - e0up); gfij0dn = 1.d0/(esusc(ie) - e0dn)
          gfjiwup = 1.d0/(esusc(ie) - e0up); gfjiwdn = 1.d0/(esusc(ie) - e0dn)
          gfji0up = conjg(gfij0up); gfji0dn = conjg(gfij0dn)
          gfijwup = conjg(gfjiwup); gfijwdn = conjg(gfjiwdn)
!          gfij0up = gfij0(lmsb2i(1,5,2,ia),lmsb2i(1,5,2,ia)); gfij0dn = gfij0(lmsb2i(1,5,1,ia),lmsb2i(1,5,1,ia))
!          gfji0up = gfji0(lmsb2i(1,5,2,ia),lmsb2i(1,5,2,ia)); gfji0dn = gfji0(lmsb2i(1,5,1,ia),lmsb2i(1,5,1,ia))
!          gfijwup = gfijw(lmsb2i(1,5,2,ia),lmsb2i(1,5,2,ia)); gfijwdn = gfijw(lmsb2i(1,5,1,ia),lmsb2i(1,5,1,ia))
!          gfjiwup = gfjiw(lmsb2i(1,5,2,ia),lmsb2i(1,5,2,ia)); gfjiwdn = gfjiw(lmsb2i(1,5,1,ia),lmsb2i(1,5,1,ia))
          chi0escf_updn = chi0escf_updn + (conjg(de)*gfji0up*gfijwdn - de*gfij0up*gfjiwdn)/i2pi
          chi0escf_dnup = chi0escf_dnup + (conjg(de)*gfji0dn*gfijwup - de*gfij0dn*gfjiwup)/i2pi
        end do            ! energy
!       --------------------------------------------------------------
!      write(*,'("Analytic desum=",2es16.8)') desum
        call cpu_time(finish)
...
!              gfji0 = conjg(transpose(gfji0))
              do j=1,jq1-jq0
                ...
                do i=1,iq1-iq0
                  ...
                  i3 = i2almsbgf(:,iq)
                  q1 = i3(1); q2 = i3(2)!; ia = i3(3)
                  norm = -de*gfij0(q2,q3)*(gfijw(q4,q1) - gfjiw(q4,q1))/i2pi
                  suscblock(i,j) = suscblock(i,j) + norm
                end do
              end do
              gfij0up = 1.d0/(esusc(iew) - e0up); gfij0dn = 1.d0/(esusc(iew) - e0dn)
...
!              gfijwup = gfijw(lmsb2i(1,5,2,ia),lmsb2i(1,5,2,ia)); gfijwdn = gfijw(lmsb2i(1,5,1,ia),lmsb2i(1,5,1,ia))
!              gfjiwup = gfjiw(lmsb2i(1,5,2,ia),lmsb2i(1,5,2,ia)); gfjiwdn = gfjiw(lmsb2i(1,5,1,ia),lmsb2i(1,5,1,ia))
              chi0eb_updn = chi0eb_updn - de*gfij0up*(gfijwdn - gfjiwdn)/i2pi
              chi0eb_dnup = chi0eb_dnup - de*gfij0dn*(gfijwup - gfjiwup)/i2pi
            end do  ! energy
!         ++++++
          end do
!         ++++++
...
!         Integration on real axis around Efermi
          suscblock = czero; desum = czero
!         This is the distance from the panels to the real axis
          eim = cmplx(0.d0,-aimag(esusc(nescf)))
          iew = 0; jew = 0
!         ++++++++++++++++
!         loop over panels
          do jw=1,iw
...
!             handle efermi (not repeated in energy mesh)
              ...
              de1 = esusc(iew) - esusc(iew1)
              de2 = esusc(jew) - esusc(jew1)
!              write(*,'(6i6,8es16.8)') iew0, iew, iew1, jew0, jew, jew1, esusc(iew)-esusc(iew1), esusc(jew)-esusc(jew1)
              desum = desum + de
!              write(*,'(4i8,8es16.8)') iew0, jew0, iew, jew, esusc(iew), esusc(jew), esusc(iew) - esusc(jew), de
!             get the projected GFs
!             E + i0
              call projected_gf(iew,ia,ja,gfij0,onsite,struct)
              if (lrot) call local_frame(ia,ja,magdir,gfij0,gf)
              call projected_gf(iew1,ia,ja,gfji0,onsite,struct)
              if (lrot) call local_frame(ia,ja,magdir,gfji0,gf)
              gfij0 = gfij0 + (eim/de1)*(gfij0 - gfji0)
!              gfij0 = (eim/de1)*(gfij0 - gfji0)
!              gfji0 = conjg(transpose(gfji0))
!             E - w + i0
              call projected_gf(jew,ja,ia,gfjiw,onsite,struct)
              if (lrot) call local_frame(ja,ia,magdir,gfjiw,gf)
              call projected_gf(jew1,ja,ia,gfijw,onsite,struct)
              if (lrot) call local_frame(ia,ja,magdir,gfijw,gf)
              gfjiw = gfjiw + (eim/de2)*(gfjiw - gfijw)
!              gfjiw = (eim/de2)*(gfjiw - gfijw)
!             E - w - i0
              gfijw = conjg(transpose(gfjiw))
              do j=1,jq1-jq0
                jq = jq0 + j
...
!              gfijwup = gfijw(lmsb2i(1,5,2,ia),lmsb2i(1,5,2,ia)); gfijwdn = gfijw(lmsb2i(1,5,1,ia),lmsb2i(1,5,1,ia))
!              gfjiwup = gfjiw(lmsb2i(1,5,2,ia),lmsb2i(1,5,2,ia)); gfjiwdn = gfjiw(lmsb2i(1,5,1,ia),lmsb2i(1,5,1,ia))
              chi0ef_updn = chi0ef_updn + de*gfij0up*(gfijwdn - gfjiwdn)/i2pi
              chi0ef_dnup = chi0ef_dnup + de*gfij0dn*(gfijwup - gfjiwup)/i2pi
            end do  ! energy
!         ++++++
          end do
!         ++++++
...
! ******
  close(iofile)
  deallocate(suscblock,suscwork,zw)
