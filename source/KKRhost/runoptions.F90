...
module mod_runoptions
  ...
  logical :: calc_lmdos = .false.                      !!calculate lm-lm decomposed density and store to file `gflle` (former: 'lmlm-dos')
  ...
  logical :: use_SpinOrbitCoupling = .false.           !!enable spin orbit coupling (formerly related: 'NOSOC')
  ...
  logical :: write_kkrimp_files = .false.              !!write out files for KKRimp-code (former: 'KKRFLEX')
  logical :: write_kkrsusc_files = .false.             !!write out files for KKRsusc-code (former: 'KKRSUSC')
  ...
  logical :: write_pkkr_files = .false.                !!write out files for Pkkprime-code (former: 'FERMIOUT')
