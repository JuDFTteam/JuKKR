...
contains
  ...
  subroutine outpothost(alat, ins, krel, kmrot, nspin, naez, natyp, efermi, bravais, rbasis, qmtet, qmphi, noq, kaoez, iqat, zat, conc, ipan, ircut, solver, soc, ctl, irws, rmt, &
    rws, rr, drdi, visp, irshift, rmrel, drdirel, vtrel, btrel, lmaxd, natypd, naezd, ipand, irmd)
    ! **********************************************************************
    ! *                                                                    *
    ...
    ! ..
    ! .. Array arguments
    real (kind=dp) :: bravais(3, 3), btrel(irmd*krel+(1-krel), *), conc(*), ctl(krel*lmaxd+1, *), drdi(irmd, *), drdirel(irmd*krel+(1-krel), *), qmphi(*), qmtet(*), rbasis(3, *), &
      rmrel(irmd*krel+(1-krel), *), rmt(*), rr(irmd, *), rws(*), soc(krel*lmaxd+1, *), visp(irmd, *), vtrel(irmd*krel+(1-krel), *), zat(*)
    integer :: ipan(*), iqat(*), ircut(0:ipand, *), irshift(*), irws(*), kaoez(natypd, *), noq(naezd)
    ! ..
    ! .. Locals
    ...
    ! .. 1     2     3     4    5     6     7     8     9     0
    data elemname/'Vac', 'H  ', 'He ', 'Li ', 'Be', 'B  ', 'C  ', 'N  ', 'O  ', 'F  ', 'Ne ', 'Na ', 'Mg ', 'Al ', 'Si', 'P  ', 'S  ', 'Cl ', 'Ar ', 'K  ', 'Ca ', 'Sc ', 'Ti ', &
      ...
      'Cf ', 'Es ', 'Fm ', 'Md ', 'No ', 'Lr ', 'Rf', 'Db ', 'Sg ', 'Bh ', 'Hs ', 'Mt ', 'Uun', 'Uuu', 'Uub', 'NoE'/
    ! ..
