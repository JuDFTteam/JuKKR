...
#ifdef CPP_MPI
  subroutine mympi_main1c_comm(IRMD,LMPOTD,NATYPD,LMAXD,LMAXD1,LMMAXD,NPOTD,IELAST,MMAXD,IDOLDAU,NATYP,KREL,  &
...
#ifdef CPP_MPI
  subroutine mympi_main1c_comm_newsosol2(LMAXD1,LMMAXD,IELAST,NQDOS,      &
