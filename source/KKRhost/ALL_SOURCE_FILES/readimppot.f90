 ...
 DO ISPIN = 1,NSPIN
  ...
  END IF                  ! INS.GT.0
   ...
   IF (INS.GT.1) THEN
    ...
    CALL POTCUT(IMT1,IRC1,INS,LMPOT,RIMP(1,IH),VM2ZIMP(1,I), dummy2,VINSIMP(IRMIND,1,I),ZIMP(IH),IRMD,IRMIND)
   END IF
   ...
   IF (INS.EQ.0 .AND. KWS.EQ.0) THEN
    ...
    IMT1 = IMT(IH)
    IRWS1 = IRWSIMP(IH)
    CALL POTCUT(IMT1,IRWS1,INS,LMPOT,RIMP(1,IH),VM2ZIMP(1,I), dummy2,VINSIMP(IRMIND,1,I),ZIMP(IH),IRMD,IRMIND)
