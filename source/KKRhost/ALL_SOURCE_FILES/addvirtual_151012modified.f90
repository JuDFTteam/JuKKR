subroutine ADDVIRATOMS(LINTERFACE, naez, naezd, natypd,NEMBD, RBASIS, &
...
!interface variables
      ...
      integer             :: NAEZD
      integer             :: NAtypd
      integer             :: NEMBD,NEMB,NACLSD
      parameter (NACLSD=1000)

      real*8              :: rbasisold(3,naezd)
      real*8              :: RBASIS1(3,naezd+nembd)
      integer             :: NLBASIS,NRBASIS,NLEFT,NRIGHT,IER,I,I1,J
      real*8              :: RBASIS(3,*),TLEFT(3,*),TRIGHT(3,*)
      real*8              :: ZPERIGHT(3),ZPERLEFT(3),TEMP(3)
...
!--------------------------------------------------
! change rbasis to cartesian coordinates
!--------------------------------------------------
      DO I = 1,NAEZ + NEMB
