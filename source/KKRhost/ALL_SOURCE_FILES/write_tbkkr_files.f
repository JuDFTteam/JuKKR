...
!       ENDDO
     ...
     +                           NACLSD, 'naclsd', IELAST, 'ielast',  !repalce naclsd by naclsmax to not waste any memory
!      +                           NACLSMAX, 'naclsd', IELAST, 'ielast',  !repalce naclsd by naclsmax to not waste any memory
     +                           INS, 'ins'                           
          CLOSE(934)                                                  
