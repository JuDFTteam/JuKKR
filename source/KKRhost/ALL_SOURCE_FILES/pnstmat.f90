...
subroutine pnstmat(drdi, ek, icst, pz, qz, fz, sz, pns, tmatll, vins, irmin, &
  ...
  ! .. Local Scalars ..
  ! ..
  complex (kind=dp) :: fz(irmd, 0:lmaxd), pns(lmmaxd, lmmaxd, irmind:irmd, 2), &
  ...
  complex (kind=dp) :: ar(lmmaxd, lmmaxd), cmat(lmmaxd, lmmaxd, irmind:irmd), &
  ...
  call wftsca(drdi, efac, pz, qz, fz, sz, nsra, pzlm, qzlm, pzekdr, qzekdr, &
    ek, loflm, irmind, irmd, irmin, irmax, lmaxd, lmmaxd) ! Added IRMIN,IRMAX
                                                          ! 1.7.2014  &
