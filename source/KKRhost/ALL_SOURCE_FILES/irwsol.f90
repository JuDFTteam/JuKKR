...
subroutine irwsol(ek, fz, hamf, mass, pz, qz, sz, dror, s, ipan, ircut, irmd, &
  ...
  ! ..
  ! .. Local Scalars ..
  complex (kind=dp) :: hamf1, k1f, k1p, k2f, k2p, k3f, k3p, k4f, k4p, mass1, &
    qim0, qim1, sim0, sim1
  ...
  do l = 0, lmaxd
    ...
    do ip = ipan, 1, -1
      ...
      do ir = irs - 5, ire, -1
        ...
        qim0 = qim0 - (251.0e0_dp*dqdi(0)+646.0e0_dp*dqdi(1)-264.0e0_dp*dqdi(2 &
          )+106.0e0_dp*dqdi(3)-19.0e0_dp*dqdi(4))/720.0e0_dp
        sim0 = sim0 - (251.0e0_dp*dsdi(0)+646.0e0_dp*dsdi(1)-264.0e0_dp*dsdi(2 &
          )+106.0e0_dp*dsdi(3)-19.0e0_dp*dsdi(4))/720.0e0_dp
