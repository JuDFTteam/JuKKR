...
contains
  ...
  subroutine madelung2d(lpot, yrg, wg, naez, alat, vol, bravais, recbv, rbasis, rmax, gmax, nlbasis, nleft, zperleft, tleft, nrbasis, nright, zperight, tright, lmxspd, lassld, &
    ...
    ! ======================================================================
    call lattice2d(alat, bravais, recbv, ngmax, nrmax, nshlg, nshlr, nsg, nsr, gn2, rm2, rmax, gmax, iprint, nmaxd, ishld)
    ! ======================================================================
    ...
    do iq1 = 1, naez
      ...
      do iq2 = 1, naez
        ...
        call ewald2d(lpot, alat, rbasis(1,iq1), rbasis(1,iq2), iq1, iq2, rm2, nrmax, nshlr, nsr, gn2, ngmax, nshlg, nsg, sum, vol, lassld, lmxspd)
        ! WRITE(99,*) 'SUM: ',SUM
        ...
        call madelcoef(.true., lpot, avmad, bm, sum, cleb, icleb, iend, lpotd, lmpotd, lmxspd, nclebd)
      ...
      do iq1 = 1, naez
        ...
        do ih = 1, nleft
          do ib = 1, nlbasis
            ...
            call ewald2d(lpot, alat, rbasis(1,iq1), vec2, iq1, ih, rm2, nrmax, nshlr, nsr, gn2, ngmax, nshlg, nsg, sum, vol, lassld, lmxspd)
