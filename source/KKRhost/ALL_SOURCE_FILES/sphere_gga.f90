...
contains
  ...
  subroutine sphere_gga(lmax, yr, wtyr, rij, ijd, lmmaxd, thet, ylm, dylmt1, dylmt2, dylmf1, dylmf2, dylmtf)
    ! -----------------------------------------------------------------------
    ...
    ! ..
    ! .. Array Arguments ..
    real (kind=dp) :: dylmf1(ijd, lmmaxd), dylmf2(ijd, lmmaxd), dylmt1(ijd, lmmaxd), dylmt2(ijd, lmmaxd), dylmtf(ijd, lmmaxd), rij(ijd, 3), thet(ijd), wtyr(ijd, *), &
      ylm(ijd, lmmaxd), yr(ijd, *), dydth(lmmaxd), dydfi(lmmaxd), d2ydth2(lmmaxd), d2ydfi2(lmmaxd), d2ydthdfi(lmmaxd)
    ! ..
    ! .. Local Arrays ..
