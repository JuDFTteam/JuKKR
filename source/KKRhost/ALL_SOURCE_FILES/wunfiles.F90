...
! integer
   ...
   subroutine get_params_1b(t_params,NATYPD, NAEZD, NATYP,NACLSD,IELAST,NPOL,NCLSD,NREFD, NREF,NEMBD,   &
      ...
      write(1122,*) 'line1', NSRA    
      write(1122,*) 'line2', INS     
      write(1122,*) 'line3', NATYP   
      write(1122,*) 'line4', NAEZ    
      write(1122,*) 'line5', NSPIN   
      write(1122,*) 'line6', LMAX    
      write(1122,*) 'line7', NREF    
      write(1122,*) 'line8', ICC     
      write(1122,*) 'line9', IGF     
      write(1122,*) 'line10', NLBASIS 
      write(1122,*) 'line1', NRBASIS 
      write(1122,*) 'line2', NCPA    
      write(1122,*) 'line3', ICPA    
      write(1122,*) 'line4', ITCPAMAX
      write(1122,*) 'line5', CPATOL 
      write(1122,*) 'line6', ALAT      
      write(1122,*) 'line7', RBASIS    
      write(1122,*) 'line8', REFPOT    
      write(1122,*) 'line9', RMTREF    
      write(1122,*) 'line20', VREF      
      write(1122,*) 'line1', RCLS      
      write(1122,*) 'line2', RR        
      write(1122,*) 'line3', ATOM      
      write(1122,*) 'line4', CLS       
      write(1122,*) 'line5', NCLS      
      write(1122,*) 'line7', EZOA      
      write(1122,*) 'line8', NACLS     
      write(1122,*) 'line30', NSHELL    
      write(1122,*) 'line1',  KMROT     
      write(1122,*) 'line2', KAOEZ     
      write(1122,*) 'line3', IQAT      
      write(1122,*) 'line4', NOQ       
      write(1122,*) 'line5', CONC      
      write(1122,*) 'line6', KMESH     
      write(1122,*) 'line7', MAXMESH   
      write(1122,*) 'line8', LLY       
      write(1122,*) 'line9', NSYMAT    
      write(1122,*) 'line40', NATOMIMP  
      write(1122,*) 'line1', NQCALC    
      write(1122,*) 'line2', RATOM     
      write(1122,*) 'line3', RROT      
      write(1122,*) 'line4', NSH1      
      write(1122,*) 'line5', NSH2      
      write(1122,*) 'line6', DROTQ     
      write(1122,*) 'line7', IJTABCALC 
      write(1122,*) 'line8', IJTABCALC_I
      do I=1,NSHELL(0)
         do L=1,NOFGIJ
            write(1122,*) 'line9', ISH(I,L)
            write(1122,*) 'line50', JSH(I,L)
         end do
      end do
      write(1122,*) 'line51', IJTABSYM  
      write(1122,*) 'line2', IJTABSH   
      write(1122,*) 'line3', IQCALC    
      write(1122,*) 'line4', DSYMLL    
      write(1122,*) 'line5', INVMOD    
      write(1122,*) 'line6', ICHECK    
      write(1122,*) 'line7', ATOMIMP   
      write(1122,*) 'line8', SYMUNITARY
      write(1122,*) 'line9', TMPDIR    
      write(1122,*) 'line60', ITMPDIR   
      write(1122,*) 'line1', ILTMP     
      write(1122,*) 'line2', RCLSIMP   
      IF ( KREL.EQ.1 ) then
         write(1122,*) 'line1', RC    
         write(1122,*) 'line2', CREL  
         write(1122,*) 'line3', RREL  
         write(1122,*) 'line4', SRREL 
         write(1122,*) 'line5', NRREL 
         write(1122,*) 'line6', IRREL 
      endif
      IF ( OPT('DECIMATE') ) THEN
         write(1122,*) 'line7', LEFTTINVLL  
         write(1122,*) 'line8', RIGHTTINVLL 
         write(1122,*) 'line9', VACFLAG     
         write(1122,*) 'line70', IDECI 
      END IF
      DO L = 1,MAXMESH
            write(1122,*) 'line71', NOFKS(L)
            write(1122,*) 'line2', VOLBZ(L)
         DO I=1,NOFKS(L)
               DO ID=1,3
                  write(1122,*) 'line3', BZKP(ID,I,L)
               ENDDO
               write(1122,*) 'line4', VOLCUB(I,L)
         END DO
      END DO
      !-------------------------------------------------------------------------
      ! Energy_mesh
      !-------------------------------------------------------------------------
      write(1122,*) 'line5', IELAST
      write(1122,*) 'line6', EZ    
      write(1122,*) 'line7', WEZ   
      write(1122,*) 'line8', NPOL  
      !-------------------------------------------------------------------------
      ! Itermdir
      !-------------------------------------------------------------------------
      IF (OPT('ITERMDIR')) THEN
         write(1122,*) 'line9', DROTQ 
         IF ( KMROT.EQ.0 ) write(1122,*) 'lineo', KMROT
      END IF
