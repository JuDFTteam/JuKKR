...
subroutine cmatstr(str, lstr, a, n, m, mlin, mcol, ijq, tolp, k_fmt_fil)
  ...
  integer :: i, i1, ic0, id, il, ilsep(20), ipt(218), iq, isl, iw(m), j, j0, &
    jp, jq, k, l3, lf, mm, n1, n2, n3, nc, nd, nfil, nk, nm, nm1, nm2, nm3, &
    nnon0, nsl
...
110 format (/, 8x, a, /)
120 format (/, 1x, 79('*'), /, 10x, 'inconsistent call of <CMATSTR>', /, 10x, &
    'argument IJQ =', i8, '  implies IQ=', i3, '   JQ=', i3, /, 10x, 'IQ*N=', &
    i6, ' > M   or   JQ*N=', i6, ' > M   for N =', i4, ' M=', i4, /, 1x, &
    79('*'), /)
