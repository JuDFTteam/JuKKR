...
120 format (6x, 'WARNING: Calculation range JIJRAD missing from your input', /, 6x, '         Default value JIJRAD = 0.0 will be assumed', /)
130 format (6x, 'Range of calculating Jij around each atom', /, 6x, '      spherical cluster of radius :', f7.4, ' (ALAT)', /, /, 6x, 'Sites j sought within a parallelipiped', /, &
      6x, 'of size  (', i3, '*a_1) X (', i3, '*a_2) X (', i3, '*a_3)')
140 format (6x, 'Range of calculating Jij around each atom', /, 6x, '    cylindrical cluster of radius :', f7.4, ' (ALAT)', /, 6x, '                           height :', f7.4, &
      ' (ALAT)', /, /, 6x, 'Sites j sought within a parallelipiped', /, 6x, 'of size  (', i3, '*a_1) X (', i3, '*a_2) X (', i3, '*a_3)')
150 format (6x, 'Calculations restricted within the unit cell')
160 format (6x, ' - all of the', i3, ' atoms of the u.c. ', 'will be taken into account', /)
170 format (6x, ' - only', i3, ' atom(s) (out of', i3, ') in the u.c.', 'will be calculated', /)
180 format (6x, 'Dimension ERROR: please increase the ', a, ' parameter', /, 6x, a, ' to a value >=', i5, /)
190 format (8x, 'Jij connections set', /, 10x, 20('-'), /, 11x, ' I ', 3x, 'no. of J''S', /, 10x, 20('-'))
