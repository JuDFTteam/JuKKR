...
contains
  ...
  subroutine wfint0(cder, dder, qzlm, qzekdr, pzekdr, vnspll, nsra, irmind, irmd, lmmaxd, irmin, irmax) ! Added IRMIN,IRMAX 1.7.2014
    ! -----------------------------------------------------------------------
    ...
    ! ..
    ! .. Array Arguments ..
    complex (kind=dp) :: cder(lmmaxd, lmmaxd, irmind:irmd), dder(lmmaxd, lmmaxd, irmind:irmd), pzekdr(lmmaxd, irmind:irmd, 2), qzekdr(lmmaxd, irmind:irmd, 2), &
  ...
  subroutine wfint(qns, cder, dder, qzekdr, pzekdr, vnspll, nsra, irmind, irmd, lmmaxd, irmin, irmax) ! Added IRMIN,IRMAX 1.7.2014
    ! -----------------------------------------------------------------------
    ! determines the integrands CDER, DDER or ADER, BDER in the
    ! integral equations for the non-spherical wavefunctions from
    ! the non-spherical contributions of the potential vinsPLL.
    ...
    ! ..
    ! .. Array Arguments ..
    complex (kind=dp) :: cder(lmmaxd, lmmaxd, irmind:irmd), dder(lmmaxd, lmmaxd, irmind:irmd), pzekdr(lmmaxd, irmind:irmd, 2), qns(lmmaxd, lmmaxd, irmind:irmd, 2), &
    ...
    ! ..
    ! .. Local Arrays ..
    real (kind=dp) :: qnsi(lmmaxd, lmmaxd), qnsr(lmmaxd, lmmaxd), vtqnsi(lmmaxd, lmmaxd), vtqnsr(lmmaxd, lmmaxd)
    ! ..
    ...
    do ir = irmin, irmax
      ...
      call dgemm('N', 'N', lmmaxd, lmmaxd, lmmaxd, 1.e0_dp, vnspll(1,1,ir), lmmaxd, qnsr, lmmaxd, 0.e0_dp, vtqnsr, lmmaxd)
      call dgemm('N', 'N', lmmaxd, lmmaxd, lmmaxd, 1.e0_dp, vnspll(1,1,ir), lmmaxd, qnsi, lmmaxd, 0.e0_dp, vtqnsi, lmmaxd)
      do lm1 = 1, lmmaxd
        do lm2 = 1, lmmaxd
