...
! .. Output variables
      Real (Kind=dp), Dimension (irmd, lmpot, npotd), Intent (Out) :: vons !< output potential (nonspherical VONS)
! ..
...
!----------------------------------------------------------------------
          Call vxcgga(exc, kte, kxc, lpot, nspin, iatyp, rho2iat, &
            ...
            dylmt1, dylmt2, dylmf1, dylmf2, dylmtf, lmpot, lmmaxd, &
            lpot, natyp)
        End If
      End Do
    End Subroutine
