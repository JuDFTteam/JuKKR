subroutine decimaread(ez, tk, nptp1, nptp2, nptp3, npol, ispin, lefttinvll, &
  ...
  nspin, lmmax, ielast, fileleft, fileright, krel, natypd, lmmaxd, nembd1) !,KORBIT)
! **********************************************************************
! *                                                                    *
...
! ......................................................................
        if ((krell/=krel) .or. (kmrotl/=kmrot) .or. (insl/=ins) .or. &
          ...
          write (6, '(8X,A6,6I6)') 'syst: ', krel, kmrot, ins, nspin, lmmax, &
            nathost
          write (6, '(8X,A6,6I6,/)') 'host: ', krell, kmrotl, insl, nspinl, &
            lmmaxl, naezl
          stop '       < DECIMAREAD > '
        end if
! ......................................................................
...
! ......................................................................
        if ((npt1l/=nptp1) .or. (npt2l/=nptp2) .or. (npt3l/=nptp3) .or. &
          ...
          write (6, '(8X,A6,4I6,2X,F10.6)') 'input:', nptp1, nptp2, nptp3, &
            npol, tk
          write (6, '(8X,A6,4I6,2X,F10.6,/)') ' host:', npt1l, npt2l, npt3l, &
            npoll, templ
          stop '       < DECIMAREAD > '
        end if
! ......................................................................
...
130 format (10x, 'ALAT=', f9.6, ' NSPIN=', i2, '  NAEZ=', i3, ' LMMAX=', i3, &
