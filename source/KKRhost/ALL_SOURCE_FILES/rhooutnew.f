     ...
     +                      GFLLE_PART,RPAN_INTERVALL,IPAN_INTERVALL)
       ...
       INTEGER IRMDNEW,NPAN_TOT,NCHEB,IMT1
       ...
       DOUBLE PRECISION THETASNEW(NTOTD*(NCHEBD+1),NFUND)
       ! not that SLL is not needed for calculation of density, 
       ! only needed for calculation of Green function
