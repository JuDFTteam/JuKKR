...
subroutine create_wmatrix(theta, phi, theta_old, phi_old, lmmax, wmat1, wmat2)
  ...
  call zgemm('N', 'N', 2*lmmax, 2*lmmax, 2*lmmax, (1e0_dp,0e0_dp), udeggamat2, &
    2*lmmax, umat1, 2*lmmax, (0e0_dp,0e0_dp), wmat1, 2*lmmax)
  call zgemm('N', 'N', 2*lmmax, 2*lmmax, 2*lmmax, (1e0_dp,0e0_dp), udeggamat1, &
    2*lmmax, umat2, 2*lmmax, (0e0_dp,0e0_dp), wmat2, 2*lmmax)
