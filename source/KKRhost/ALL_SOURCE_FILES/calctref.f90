...
contains
  ...
  subroutine calctref13(eryd, vref, rmtref, lmax, lmtmat, trefll, dtrefll, alpharef, dalpharef, lmaxdp1, lmmaxd)
    ...
    do l1 = 0, lmax
      ...
      da1 = 0.5e0_dp/roote1*bessjw1(l1+1)*bessjw2(l1) - 0.5e0_dp/roote2*bessjw1(l1)*bessjw2(l1+1) + roote1*dbessjw1(l1+1)*bessjw2(l1) - roote2*dbessjw1(l1)*bessjw2(l1+1) + &
        roote1*bessjw1(l1+1)*dbessjw2(l1) - roote2*bessjw1(l1)*dbessjw2(l1+1)

      db1 = 0.5e0_dp/roote1*hankws1(l1+1)*bessjw2(l1) - 0.5e0_dp/roote2*hankws1(l1)*bessjw2(l1+1) + roote1*dhankws1(l1+1)*bessjw2(l1) - roote2*dhankws1(l1)*bessjw2(l1+1) + &
