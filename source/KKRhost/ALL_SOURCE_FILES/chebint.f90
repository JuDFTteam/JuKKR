...
subroutine chebint(cslc1, csrc1, slc1sum, c1, n)
  ...
  call dgemm('T', 'N', n+1, n+1, n+1, 1.e0_dp, c, n+1, c, n+1, 0.e0_dp, sr, &
    n+1)
  call dgemm('N', 'N', n+1, n+1, n+1, 1.e0_dp, c1, n+1, c, n+1, 0.e0_dp, sr, &
    n+1)
  ! ---------------------------------------------------------------------
  ...
  s2(1, 0) = 1.e0_dp
  s2(1, 2) = -0.5e0_dp
  call dgemm('N', 'N', n+1, n+1, n+1, 1.e0_dp, s1, n+1, s2, n+1, 0.e0_dp, sl, &
    n+1)
  do j = 0, n
    do k = 0, n
      s1(k, j) = 0.0e0_dp
  ...
  call dgemm('N', 'N', n+1, n+1, n+1, 1.e0_dp, s1, n+1, s2, n+1, 0.e0_dp, sr, &
    n+1)
  ! ---------------------------------------------------------------------
