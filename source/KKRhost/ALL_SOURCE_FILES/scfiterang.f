...
C
      ...
      REAL*8 FACT(0:100),MVGAM(NTMAX,NMVECMAX),MVPHI(NTMAX,NMVECMAX),
...
C Local variables
C
      REAL*8 A,B,C,PHIXTR,TETXTR
      REAL*8 DELPHI,DELTET,LASTERR,MIXING,QMGAMMIX,
     &       QMPHIMIX,QMTETMIX,WN,WO
      INTEGER I,IMV,IPREV,IPRINT,IQ,IT,ITAB,IXTR
      REAL*8 QMGAMTAB(NQMAX,3),QMPHITAB(NQMAX,3),QMTETTAB(NQMAX,3)
