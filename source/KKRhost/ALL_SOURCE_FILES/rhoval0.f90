...
subroutine RHOVAL0(EZ,DRDI,RMESH,IPAN,IRCUT,IRWS,THETAS,DOS0,DOS1)
   ...
   ! .. Local Arrays ..
   double complex, dimension(0:LMAXD1) :: BESSJW
   double complex, dimension(0:LMAXD1) :: BESSYW
   double complex, dimension(0:LMAXD1) :: HANKWS
   double complex, dimension(IRMD,0:LMAXD)   :: PZ
   double complex, dimension(IRMD,0:LMAXD)   :: QZ
   double complex, dimension(IRMD,0:LMAXD1)  :: CDEN0
   double complex, dimension(IRMD,0:LMAXD1)  :: CDEN1
