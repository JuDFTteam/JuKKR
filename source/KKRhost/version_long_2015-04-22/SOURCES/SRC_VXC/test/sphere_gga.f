      SUBROUTINE SPHERE_GGA_OLD(LMAX,YR,WTYR,RIJ,IJD,LMMAXD,THET,YLM,
...
c
   ...
   30 CONTINUE
      ...
      CALL CYL0M2(LMAX,COSX,FAI,2*LMAX+1,LMMAXD,THET,YLM,DYLMT1,DYLMT2,
...
c Inside:
      ...
      real*8 xy,xyz,sgm,sgmm
      real*8 aux
      real*8 tiny
      parameter(tiny=1.d-20)  ! if th < tiny set th=0
      real*8 th2,dth  ! for numerical differentiation test(see imode=2)
      ...
      integer imode ! imode = 1 or 2, depending on the method to use.
      integer imm,ipm,lpm,lmm,lpmp1,lmmp1 ! i-m,i+m,l+m,l-m,l+m+1,l-m-1
      parameter (imode=2) ! 1=analytical, 2=numerical (for testing)
