...
C Local variables
C
      REAL*8 A11,A12,A21,A22,AA11,AA12,AA21,AA22,ALPHA,BB1,BB2,BETA,
     &       BOVA,BPP,BQQ,DIFFA,DIFFB,DMUE,EMVPP,EMVQQ,W1,W2,W3,W4,W5,
     &       W6,W7
      REAL*8 BC(0:NPEMAX),CG1,CG2,CG4,CG5,CG8,CSQR,DET,DVC,GAM(2),GPM,
...
C
C MB
C     REAL*8 CM(INVMAX,INVMAX),CMI(INVMAX,INVMAX)
C MB
C
C
      H24 = 1.0D0/24.0D0
