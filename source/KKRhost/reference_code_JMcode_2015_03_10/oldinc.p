...
C              should be 1, if you don't do such a calculation
...
C     general settings
      ...
      PARAMETER ( LMAXD = 3 )
      PARAMETER ( IEMXD = 150 )
      PARAMETER ( IRMD = 484, IRNSD = 400 )
      PARAMETER ( NRD = 20000, KPOIBZ = 32000 )
      PARAMETER ( NMAXD = 40000, ISHLD= 700 )
      PARAMETER ( NTREFD = 0 )             ! must be 0 for host program
C ---------------------------------------------------------------------
C     structure-dependent
      PARAMETER ( NATYPD = 8 )
      PARAMETER ( NAEZD = 8 )
      PARAMETER ( NATOMIMPD = 500 )
c     PARAMETER ( NSHELD = NATYPD + NATOMIMPD*(NATOMIMPD-1) )
      PARAMETER ( NSHELD = NATYPD + 2*NATOMIMPD + 10 )       ! test brahim
      PARAMETER ( NREFD = 1 )
      PARAMETER ( NPRINCD =  1 )
      PARAMETER ( NEMBD = 0 )
C ---------------------------------------------------------------------
C     non-spherical potential 
      PARAMETER ( NCELLD = 1, IPAND = 17 )
      PARAMETER ( NFUND = 24, IRID = 135, NGSHD = 13079)
C
C =====================================================================
