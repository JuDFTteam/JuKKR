...
C OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO OUTPUT
C
C --> set the reference I sites for J_IJ within the unit cell 
C     token JIJSITES allows one to specify which sites in the 
C     unit cell should be considered in the calculation (default ALL)
C
      NIQCALC = NAEZ
      DO IQ = 1,NAEZ
         IQCALC(IQ) = IQ
