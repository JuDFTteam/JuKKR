...
C OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO OUTPUT
      WRITE (6,'(5X,2A,/)') '< STRMAT > : ','calculating lattice sums'
C OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO OUTPUT
C
C
...
C OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO OUTPUT
      IF ( IPRINT.GT.2 ) THEN
         WRITE (6,99002)
         DO I2 = 1,NAEZ
            WRITE (6,99003) I2,(QI0(I,I2),I=1,3)
         END DO
         WRITE (6,99004)
      END IF
C OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO OUTPUT
...
C OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO OUTPUT
      ...
      DO I = 1,MIN(6,NAEZ)
         ...
         LFMT = LFMT + 12
      END DO
      WRITE (6,'(7X,A)') FMT(1:LFMT)
      DO I1 = 1,MIN(6,NAEZ)
         WRITE (6,99006) (SMAT(1,I1,I2),I2=1,MIN(6,NAEZ))
      END DO
      WRITE (6,'(7X,A,/)') FMT
C OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO OUTPUT
C
