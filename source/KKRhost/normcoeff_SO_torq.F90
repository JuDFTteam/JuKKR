...
contains
  ...
  !> @endnote
  !-------------------------------------------------------------------------------
  subroutine normcoeff_so_torq(natom,ircut,lmmax,pns,ntcell,ipan,lmsp,ksra,   &
              ...
              do lm1 = 1, lmmax
                do lm2 = 1, lmmax
                  ...
                  do insra = 1, nsra
                    ...
                    call calc_torq_ll_ss(lmmax, rll_12, ircut(0:ipand,i2), ipan(i2), ntcell(i2), cleb, icleb, iend, lmsp, irws(i2), drdi(:,i2), norm, visp, nspin, i1, vins, &
                      irmin(i2))
          ...
          if (isigma==1) then      ! T_x
            ...
            do i1sp1 = 1, 2
              do i1sp2 = 1, 2
                do lm1 = 1, lmmax
                  do lm2 = 1, lmmax
                    torq((i1sp2-1)*lmmax+lm2, (i1sp1-1)*lmmax+lm1, i1, isigma) = (0.0_dp, 1.0_dp)*(dens(lm2,lm1,1,i1sp2,2,i1sp1,i1)-dens(lm2,lm1,2,i1sp2,1,i1sp1,i1))*sqa(3) - &
                ...
                do lm1 = 1, lmmax
                  do lm2 = 1, lmmax
                    torq((i1sp2-1)*lmmax+lm2, (i1sp1-1)*lmmax+lm1, i1, isigma) = (dens(lm2,lm1,2,i1sp2,1,i1sp1,i1)+dens(lm2,lm1,1,i1sp2,2,i1sp1,i1))*sqa(2) - &
                      (0.0_dp, 1.0_dp)*(-dens(lm2,lm1,2,i1sp2,1,i1sp1,i1)+dens(lm2,lm1,1,i1sp2,2,i1sp1,i1))*sqa(1)
                  end do           ! LM2
                end do             ! LM1
              end do               ! I1SP2
            end do                 ! I1SP1
